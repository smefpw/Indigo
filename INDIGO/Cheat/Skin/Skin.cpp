...
void InitializeKits()
{
	...
	auto sig_address = CSX::Memory::FindPBYTEPattern("client.dll", (PBYTE)"\xE8\x00\x00\x00\x00\xFF\x76\x0C\x8D\x48\x04\xE8", "x????xxxxxxx", NULL, NULL);
	...
	// Dump sticker kits
	{
		auto sticker_sig = CSX::Memory::FindPBYTEPattern("client.dll", (PBYTE)"\x53\x8D\x48\x04\xE8\x00\x00\x00\x00\x8B\x4D\x10", "xxxxx????xxx", NULL, NULL) + 4;
